...
{
	[CategoryId("C__CATG__IT_SERVICE")]
	[CategoryDisplayName("It-service Assignment")]
	class ItserviceAssignment : Category
	{

		public enum C__CMDB__CATG__ITSERVICE__CONNECTED_OBJECT : int
		{
		}
